  ...
  <body>
    ...
    <header class="container-fluid">
      <div class="container container-header">
          <div class="row">
            <div class="col-xs-12">
              <a href="{!!asset('/')!!}"><img class="img-responsive internal-banner" src="http://blogs.altavision.com.co/images/{{$app->header_internal}}" alt="{{$app->header_internal}}" alt="logo"/></a>
            </div>
          </div>
        </div>
    </header>
      ...
      <div class="container-fluid div-fondo-blanco">
        ...
        <div class="container container-breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="active">{{$post->menu->name}}</li>
